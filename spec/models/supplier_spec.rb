  ...
  describe '#valid?' do
		...
		it 'falso quando CNPJ ja está salvo no banco de dados' do
			...
			s2 = Supplier.create(trade_name: 'Sony', company_name: 'Sony Company', registration_number: '1234567891234',
				city: 'SP', state: 'São Paulo', address: 'Avenida Japão, numero 1000', email: 'sony@email.com', phone_number: '999219823')
			#Act
			result = s2.valid?
			...
			it 'falso quando Cidade está vazio' do
				...
				s = Supplier.new(trade_name: 'Samsung', company_name: 'Samsung Company', registration_number: '1234567891234',
					city: '', state: 'São Paulo', address:'Avenida Coreia do Sul, numero 1000', email: 'samsung@email.com', phone_number: '999839823')
				#Act
				result = s.valid?
				#Assert
				expect(result).to eq false
			...
			it 'falso quando Estado está vazio' do
				#Arrange
				s = Supplier.new(trade_name: 'Samsung', company_name: 'Samsung Company', registration_number: '1234567891234',
					city: 'SP', state: '',	address:'Avenida Coreia do Sul, numero 1000', email: 'samsung@email.com', phone_number: '999839823')
				#Act
				result = s.valid?
				#Assert
				expect(result).to eq false
			...
			it 'falso quando Endereço está vazio' do
				#Arrange
				s = Supplier.new(trade_name: 'Samsung', company_name: 'Samsung Company', registration_number: '1234567891234',
					city: 'SP', state: 'São Paulo', address:'', email: 'samsung@email.com', phone_number: '999839823')
				#Act
				result = s.valid?
				#Assert
				expect(result).to eq false
		...
		it 'falso quando Email está vazio' do
			#Arrange
			s = Supplier.new(trade_name: 'Samsung', company_name: 'Samsung Company', registration_number: '1234567891234',
				city: 'SP', state: 'São Paulo', address:'Avenida Coreia do Sul, numero 1000', email: '', phone_number: '999839823')
			#Act
			result = s.valid?
			#Assert
			expect(result).to eq false
