...
describe 'Usario visita tela inicial' do
  ...
  it 'e vê os galpões cadastrados' do
    ...
    Warehouse.create(name: 'Rio', code: 'RIO',  city: 'Rio de Janeiro', area: 70_000, address: 'Av principal, numero 1000', postal_code: '31000-000', description: 'Galpão principal do Rio de Janeiro')
